...
function RootLayout() {
  ...
  // leaves `contentStyle` unset. `DefaultTheme`/`DarkTheme` ship
  // rgb(242,242,242) and pure white — unrelated to our tokens — which is where
  // the white flashes between screens came from. Rebuild the theme from the
  // same CSS variables the HeroUI screens use so both layers always agree.
