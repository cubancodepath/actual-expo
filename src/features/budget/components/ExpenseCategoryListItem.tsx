...
import { ContextMenu } from "@/design-system/atoms/ContextMenu";
...
import { useSheetValue, useSheetValueNumber } from "@/shared/hooks/useSheetValue";
...
interface ExpenseCategoryListItemProps {
...
export const ExpenseCategoryListItem = memo(function ExpenseCategoryListItem({
  cat,
  sheet,
  month,
  isIncome,
